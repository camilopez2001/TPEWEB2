...
<div class="container">
        ...
        <ul class="list-group">
            ...
            {foreach from=$games item=game}
                    ...
                    {/if} 
                    <button type="button" class="btn btn-danger"><a href="delete/{$game->id}" class="btnA">Borrar</a></button> <button type="button" class="btn btn-warning"><a href="edit/{$game->id}">Editar</a></button>
                    {if $admin}
